...
const MqttClient = function(options) {
    ...
    this.topics = {
        ...
        map_calibration: this.topicPrefix + "/" + this.identifier + "/map_calibration_points",
            ...
            Tools.DRAW_MAP_PNG({
                ...
                if (!err) {
                    if (this.publishMapImage && this.client && this.client.connected === true) {
                        ...
                        this.client.publish(this.topics.map_calibration, JSON.stringify(points), {retain: true});
                    }
